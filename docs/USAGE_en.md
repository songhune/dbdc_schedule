# How to use (guest/admin)

- Choose mode from sidebar: `Guide` → `Guest` → `Admin` when needed.
- Participant password is only for loading/updating your own responses.
- Poll password protects admin actions (delete/finalize). Guests do **not** need it to vote.
